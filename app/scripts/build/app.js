...
var _modulesDropboxJsx2 = _interopRequireDefault(_modulesDropboxJsx);

var Album = (function (_DropboxComponent) {
  _inherits(Album, _DropboxComponent);
  ...
  _createClass(Album, [{
    ...
    value: function getTracks() {
      ...
      return new Promise(function (resolve, reject) {
        _this.readDir(artist + album).then(function (songs) {
          resolve(songs);
  ...
  return Album;
})(_modulesDropboxJsx2['default']);

exports['default'] = Album;
module.exports = exports['default'];

},{"./modules/Dropbox.jsx":5,"react":166}],2:[function(require,module,exports){
'use strict';
...
var View = (function (_React$Component) {
  ...
  _createClass(View, [{
    key: 'selectArtistView',
    value: function selectArtistView() {
      this.setState({ view: 'artists' });
    }
  }, {
    key: 'selectAlbumView',
    value: function selectAlbumView() {
          ...
          this.props.artists.map(function (artist) {
            return _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _this.props.albums.artist.map(function (album) {
                  return _react2['default'].createElement(_AlbumJsx2['default'], { artist: artist, album: album });
                })
              )
            );
          })
...
},{"./Album.jsx":1,"react":166}],3:[function(require,module,exports){
'use strict';
...
var _LibraryJsx = require('./Library.jsx');

var _LibraryJsx2 = _interopRequireDefault(_LibraryJsx);

var _modulesDropboxJsx = require('./modules/Dropbox.jsx');

var _modulesDropboxJsx2 = _interopRequireDefault(_modulesDropboxJsx);

var Main = (function (_DropboxComponent) {
  _inherits(Main, _DropboxComponent);
  ...
  _createClass(Main, [{
    ...
    value: function readArtistDir() {
      ...
      return new Promise(function (resolve, reject) {
        _this.readDir('/').then(function (entries) {
          _this.setState({
            artists: entries
          });
          resolve();
      ...
      if (this.state.artists.length > 0) {
        ...
        Promise.all(albumPromises).then(function (albums) {
          for (var i = 0; i < albums.length; i++) {
            var artist = _this2.state.artists[i];
        ...
        this.readArtistDir().then(function () {
          ...
          try {
            for (var _iterator2 = _this2.state.artists[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var artist = _step2.value;

              albumsObj.artist = [];
              albumPromises.push(_this2.readDir(artist));
            }
          } catch (err) {
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        this.state.loggedIn ? _react2['default'].createElement(
          ...
          this.state.artists.length && Object.keys(this.state.albums).length ? _react2['default'].createElement(_LibraryJsx2['default'], { artists: this.state.artists, albums: this.state.albums, client: this.client }) : null
        ) : _react2['default'].createElement(
          'div',
          null,
          _react2['default'].createElement(
...
},{"./Library.jsx":2,"./modules/Dropbox.jsx":5,"dropbox":11,"react":166}],4:[function(require,module,exports){
'use strict';
...
_react2['default'].render(_react2['default'].createElement(_MainJsx2['default'], null), document.getElementById('main'));

},{"./Main.jsx":3,"react":166}],5:[function(require,module,exports){
'use strict';
...
var DropboxComponent = (function (_React$Component) {
  _inherits(DropboxComponent, _React$Component);

  function DropboxComponent() {
    _classCallCheck(this, DropboxComponent);

    _get(Object.getPrototypeOf(DropboxComponent.prototype), 'constructor', this).call(this);
    this.client = new _dropbox2['default'].Client({
      key: 'tc4bq5m2e9hh24h'
    });
...
},{"dropbox":11,"react":166}],6:[function(require,module,exports){
(function (global){
/*!
