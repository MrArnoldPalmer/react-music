    ...
    value: function readAlbumDir() {
      ...
      if (this.state.artists.length > 0) {
        ...
        Promise.all(albumPromises).then(function (albums) {
          ...
          console.log(_this5.state.albums);
        });
      } else {
        this.readArtistDir().then(function () {
          ...
          try {
            for (var _iterator2 = _this5.state.artists[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              ...
              albumsObj.artist = [];
              albumPromises.push(_this5.readDir(artist));
            }
          } catch (err) {
...
},{"./Library.jsx":1,"dropbox":9,"react":164}],3:[function(require,module,exports){
'use strict';
...
},{"./Main.jsx":2,"react":164}],4:[function(require,module,exports){
(function (global){
/*!
